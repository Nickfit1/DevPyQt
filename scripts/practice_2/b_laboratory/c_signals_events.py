...
class Window(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.w_screen, self.h_screen = QtWidgets.QApplication.primaryScreen().availableGeometry().size().toTuple()
        self.ui = Ui_Form()
    ...
    def initSignals(self):
        ...
        self.ui.pushButtonCenter.clicked.connect(lambda: self.move(self.w_screen // 2 - self.width() // 2,
                                                                    self.h_screen // 2 - self.height() // 2))
